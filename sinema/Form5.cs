    ...
    public partial class Form5 : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtAd.Text != "" && txtSoyad.Text != "" && txtBiyografi.Text != "" && resimYolu != "" && txtID.Text != "")
            {
                ...
                baglanti.Open();
                MySqlCommand kayit = new MySqlCommand("insert into oyuncular (ADSOYAD,CİNSİYET,YAS,BİYOGRAFİ,RESİM,ID) VALUES (@p1,@p2,@p3,@p4,@p5,@p6)", baglanti);
                ...
                baglanti.Close();
                MessageBox.Show("Oyuncu kayıt işlemi başarılı!");
                aracTemizle();
            }
            else if (txtID.Text == "")
            {
